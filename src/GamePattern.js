...
ePatternImg[2] = res.YansuDasuan;
ePatternImg[3] = res.YansuJuanxincai;
ePatternImg[4] = res.YansuNailao;
ePatternImg[5] = res.YansuNiupai;
ePatternImg[6] = res.YansuPutaojiu;
ePatternImg[7] = res.YansuShizijia;
ePatternImg[8] = res.YansuXianglian;
...
var GamePatternSprite = cc.Sprite.extend({
    ...
    init:function (type, extraAttr) {
        ...
        switch (this.m_eExtraAttr)
        {
            ...
            {
                this.m_extraTypeSpr = cc.Sprite.create(res.DaojuHuoqiu);
                this.m_extraTypeSpr.setScale(0.7)
                break;
            }
            case ePatternExtraAttr.Freeze:
            {
                this.m_extraTypeSpr = cc.Sprite.create(res.DaojuFuyi);
                this.m_extraTypeSpr.setScale(0.7)
                break;
            }
            default:
